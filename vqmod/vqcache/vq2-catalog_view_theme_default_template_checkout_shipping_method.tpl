           ...
           <input type="button" id="loadButton" value="Open Shipping manager" onclick="loadShippingManager();" />
            <div id="shippingManager" style="display: none;">
                <iframe width="800px" height="535px" style="border: none;" frameBorder="0" />asdfasdfdas
            </div>
